export default function Footer() {
  return (
    <footer className="bg-black px-5 lg:px-0 text-white font-['SF_Pro_Display']">
      <div className="lg:px-20 py-8 lg:mx-8 lg:py-16 flex flex-col items-center">
        <div className="w-full flex flex-col gap-10 lg:gap-[23.08px] lg:flex-row lg:justify-between border-b border-[#1F2937] pb-10">
          ...
          <div className="w-full px-[41px] flex lg:flex-row gap-10 lg:w-1/2 justify-center lg:justify-start">
            <div className="w-1/2 flex flex-col items-center lg:items-start gap-4">
              <h4 className="text-white text-base font-semibold font-['SF_Pro_Display_Bold']">Product</h4>
              <ul className="space-y-2 text-gray-400 text-base text-center lg:text-left">
                <li>
                  <a href="/pricing/advanced-feature">Features</a>
                </li>
                <li>
                  <a href="/pricing">Pricing</a>
                </li>
                <li>
                  <a href="/aaa">Security</a>
                </li>
              </ul>
            </div>
            <div className="w-1/2 flex flex-col items-center lg:items-start gap-4">
              <h4 className="text-white text-base font-semibold font-['SF_Pro_Display_Bold']">Company</h4>
              <ul className="space-y-2 text-gray-400 text-base text-center lg:text-left">
                <li>
                ...
                <li>
                  <a href="/aaa">Careers</a>
                </li>
              </ul>
            </div>
          </div>
          <div className="flex flex-col overflow-hidden items-center lg:items-start gap-4 flex-1 w-full lg:max-w-[320px]">
            <h4 className="text-white text-base font-semibold text-center lg:text-left font-['SF_Pro_Display_Bold']">
        ...
        <div className="w-full max-w-[1280px] pt-6 flex flex-col items-center gap-6 lg:gap-0 lg:flex-row lg:justify-between text-base leading-6">
          <p className="text-gray-400 text-center lg:text-left">
            © 2025 PATRONIK. All rights reserved.
          </p>
          <div className="flex flex-col items-center gap-6 lg:flex-row lg:gap-6 text-gray-400 text-center">
